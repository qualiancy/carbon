...
var util = require('util')
  ...
  , debug = require('debug')('carbon:proxyRequest');
 ...
 * # proxy (options)
 *
 * Primary function to call from external components.
 * Will route the proxy request to the proper channel.
 *
 * Options:
 *
 * * `port` number
 * * `host` string
 * * `ws` boolean, defaults false
 * * `buffer` (optional)
 *
