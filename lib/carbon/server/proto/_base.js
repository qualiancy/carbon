...
var ServerState = require('./_base.state');
...
function Base(opts) {
  ServerState.call(this, '_serverState');
...
ServerState.mixin(Base.prototype, '_serverState', { delimeter: ':' });
 ...
 * #### .get(key)
 *
 * Get a stored property from this server.
 *
 * @param {String} key
 * @return {Mixed} value
 * @api public
